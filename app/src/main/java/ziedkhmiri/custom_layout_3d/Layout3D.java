package ziedkhmiri.custom_layout_3d;
...
/**
 * Created by zied khmiri on 18/11/2016.
 */
public class Layout3D extends ViewGroup {
    ...
    public Layout3D(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public Layout3D(Context context, AttributeSet attrs, int defStyleAttr) {
